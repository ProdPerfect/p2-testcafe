...
class RequestPipelineContext {
  constructor(req, res, serverInfo) {
    ...
    this.isXhr = RequestPipelineContext._isXhr(req.headers[_internalHeaderNames.default.credentials]);
    this.isFetch = !!req.headers[_internalHeaderNames.default.credentials] && !this.isXhr;
  ...
  static _isXhr(credentialsHeader) {
